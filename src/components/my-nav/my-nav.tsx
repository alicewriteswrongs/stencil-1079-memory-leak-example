...
import { getTimeGivenProgression, assert, } from '../../utils/utils'
...
export type TransitionInstruction = any;
export type Gesture = any;
export type FrameworkDelegate = any;
export type AnimationBuilder = any;
export type NavComponent = any;
export type NavOptions = any;
export type TransitionDoneFn = any;
export type NavComponentWithProps = any;
export type RouterDirection = any;
export type RouteWrite = any;
export type RouteID = any;
export type NavResult = any;
export type TransitionOptions = any;
export type ViewController = any;
...
export class Nav {
  ...
  rootChanged() {
    ...
    if (!this.useRouter) {
      ...
      console.warn('<ion-nav> does not support a root attribute when using ion-router.', this.el);
    }
  }
  ...
  private async transition(
    ...
    return this.transitionFinish(true, enteringView, leavingView, opts);
  }
